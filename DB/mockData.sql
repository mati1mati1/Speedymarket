...
VALUES 
((SELECT UserID FROM Users WHERE Email = 'john.doe@example.com'), '[{"ItemNumber": "item-001", "ItemName": "Milk", "Quantity": 2}, {"ItemNumber": "item-002", "ItemName": "Bread", "Quantity": 1}]'),
((SELECT UserID FROM Users WHERE Email = 'mike.johnson@example.com'), '[{"ItemNumber": "item-006", "ItemName": "Tomatoes", "Quantity": 3}, {"ItemNumber": "item-007", "ItemName": "Cucumbers", "Quantity": 1}]');

-- Insert mock data into BuyerOrders
INSERT INTO BuyerOrders (BuyerID, Items, TotalAmount, SellerID)
VALUES 
((SELECT UserID FROM Users WHERE Email = 'john.doe@example.com'), '[{"ItemNumber": "item-001", "ItemName": "Milk", "Quantity": 2, "Price": 10.99}, {"ItemNumber": "item-002", "ItemName": "Bread", "Quantity": 1, "Price": 5.49}]', 27.47, (SELECT SellerID FROM Sellers WHERE BranchName = 'Main Street Store')),
((SELECT UserID FROM Users WHERE Email = 'john.doe@example.com'), '[{"ItemNumber": "item-001", "ItemName": "Milk", "Quantity": 1, "Price": 10.99}, {"ItemNumber": "item-002", "ItemName": "Bread", "Quantity": 2, "Price": 5.49}]', 21.97, (SELECT SellerID FROM Sellers WHERE BranchName = 'Main Street Store')),
((SELECT UserID FROM Users WHERE Email = 'john.doe@example.com'), '[{"ItemNumber": "item-001", "ItemName": "Milk", "Quantity": 3, "Price": 10.99}, {"ItemNumber": "item-002", "ItemName": "Bread", "Quantity": 1, "Price": 5.49}]', 38.47, (SELECT SellerID FROM Sellers WHERE BranchName = 'Main Street Store')),
((SELECT UserID FROM Users WHERE Email = 'mike.johnson@example.com'), '[{"ItemNumber": "item-006", "ItemName": "Tomatoes", "Quantity": 3, "Price": 7.99}, {"ItemNumber": "item-007", "ItemName": "Cucumbers", "Quantity": 1, "Price": 8.49}]', 36.96, (SELECT SellerID FROM Sellers WHERE BranchName = 'Market Plaza')),
((SELECT UserID FROM Users WHERE Email = 'mike.johnson@example.com'), '[{"ItemNumber": "item-006", "ItemName": "Tomatoes", "Quantity": 2, "Price": 7.99}, {"ItemNumber": "item-007", "ItemName": "Cucumbers", "Quantity": 2, "Price": 8.49}]', 40.96, (SELECT SellerID FROM Sellers WHERE BranchName = 'Market Plaza')),
((SELECT UserID FROM Users WHERE Email = 'mike.johnson@example.com'), '[{"ItemNumber": "item-006", "ItemName": "Tomatoes", "Quantity": 1, "Price": 7.99}, {"ItemNumber": "item-007", "ItemName": "Cucumbers", "Quantity": 3, "Price": 8.49}]', 46.96, (SELECT SellerID FROM Sellers WHERE BranchName = 'Market Plaza'));
